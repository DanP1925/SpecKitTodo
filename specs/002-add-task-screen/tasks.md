...
- [ ] T024 [US1] Update `app/src/main/kotlin/com/example/taskprioritylist/MainActivity.kt` — replace `setContent { TaskListScreen() }` with `setContent { Theme { AppNavGraph() } }` — MainActivity owns the Theme wrapper (depends on T023)
